...
;
;
; equates for the serial input and output
serin	equ 0f000h
serout	equ	0f100h
...
copyright
	db 0ch
	DB	'MICROCOSM ASSOCIATES', 0dh, '8080/8085 CPU DIAGNOSTIC', 0dh
	DB	'VERSION 1.0  (C) 1980', 0dh, '$'
;
;
;
...
MSG:		; cp/m marks end of string with $
			; enter with hl pointing at string
			; no need to preserve de as it's not used
	mov a,m
	cpi '$'
	rz		; end of the string
	sta serout
	inx h
	jmp MSG
